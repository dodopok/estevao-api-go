...
LOG="${LOG_DIR:-/tmp}"
for pat in "puma 7" "/tmp/estevao-go" "http.server 3999" "fake_s3.py" "fake_google.py"; do
...
nohup python3 "$DIR/fake_s3.py" 9000 > "$LOG/fake_s3.log" 2>&1 &
nohup python3 "$DIR/fake_google.py" 3998 > "$LOG/fake_google.log" 2>&1 &
